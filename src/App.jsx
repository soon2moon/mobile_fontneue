...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen bg-[#f4f1ed] overflow-hidden select-none font-sans text-slate-800 flex flex-col fixed inset-0">
      ...
      <div className="absolute top-8 right-8 flex flex-col gap-2 items-end z-10 pointer-events-none">
        {PANELS_CONFIG.map(panel => {
          if (!openPanels[panel.id]) return null;
          const isExpanded = expandedPanel === panel.id;
          return (
            <div key={panel.id} className="bg-[#fdfcfa] rounded-2xl shadow-lg border border-[#e8dfdb] w-60 flex flex-col pointer-events-auto shrink-0 transition-all duration-300">
              <div 
              ...
              {isExpanded && (
                <div className="flex flex-col">
                  ...
                  {panel.id === 'layers' && (
                    <div className="p-3 flex flex-col gap-2 min-h-0 flex-1 max-h-[60vh]">
